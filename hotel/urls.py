...
urlpatterns = [
    ...
    path("country/<int:country_id>/region/", views.RegionListAPIView.as_view(), name="region_list"),
    path("region/create/", views.RegionCreateAPIView.as_view(), name="region_create"),
    path("region/update/<int:region_id>/", views.RegionUpdateAPIView.as_view(), name="region_update",),
    path("region/delete/<int:region_id>/", views.RegionDeleteAPIView.as_view(), name="region_delete",),
]
